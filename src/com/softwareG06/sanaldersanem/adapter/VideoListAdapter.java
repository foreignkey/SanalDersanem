package com.softwareG06.sanaldersanem.adapter;

import java.util.List;
import java.util.Random;


import com.softwareG06.sanaldersanem.R;
import com.softwareG06.sanaldersanem.java.VideoDetail;
import com.softwareG06.sanaldersanem.lazy.ImageLoader;
...
public class VideoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.video_listview_item,
					parent, false);
